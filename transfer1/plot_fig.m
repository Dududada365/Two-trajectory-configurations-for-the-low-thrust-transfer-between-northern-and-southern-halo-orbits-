...
axis([0.95 1.2 -0.2 0.25 -0.2 0.2])
plot3(sol.y(1,:),sol.y(2,:),ones(1,num)*(-0.2),'b','LineWidth',1)
plot3(sol.y(1,1),sol.y(2,1),ones(1,1)*(-0.2),'k*','LineWidth',2)
plot3(sol.y(1,end),sol.y(2,end),ones(1,1)*(-0.2),'k*','LineWidth',2)
...
plot3(ones(1,num)*(0.95),sol.y(2,:),sol.y(3,:),'b','LineWidth',1)
plot3(ones(1,1)*(0.95),sol.y(2,1),sol.y(3,1),'k*','LineWidth',1)
plot3(ones(1,1)*(0.95),sol.y(2,end),sol.y(3,end),'k*','LineWidth',2)
%%
%%
subplot(1,2,2)
